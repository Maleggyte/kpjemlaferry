    ...
    <div class="content" id="content">
        <div class="bg-light"
            ...
            <div class="container bg-white p-4 rounded shadow">
                <h2 class="text-center mb-4">Jadwal Keberangkatan</h2>
                            ...
                            <tbody>
                                @foreach ($jadwal as $jadwal)
                                    <tr>
                                        ...
                                        <td>{{ $jadwal->pilih_pelabuhan }}</td>
                                        <td>{{ $jadwal->nama_kapal }}</td>
                                        <td>{{ $jadwal->tanggal_keberangkatan }}</td>
                                        <td>{{ $jadwal->jam_sandar }}</td>
                                        <td>{{ $jadwal->jam_keberangkatan }}</td>
                                        <td>{{ $jadwal->dermaga }}</td>
                                        <td class="text-center">
                                            ...
                                            <form id="delete-form-{{ $jadwal->id }}"
                                                action="{{ route('jadwal-delete', $jadwal->id) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
